...
- **lex-vit/**: Handles bio-data processing, health monitoring, and vitality state management (LEX-VIT)
- **lex-wth/**: Manages financial state, ledgers, and economic runway analysis (LEX-WTH)
- **lex-mon/**: Coordinates swarm activities, monitors node health, and manages distributed state (LEX-MON)
